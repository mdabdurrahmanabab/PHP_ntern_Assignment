<?php
    ...
    $login = new DatabaseLogger();

    if (isset($_REQUEST['submit'])) {
        $usernameemail = $_POST['usernameemail'];
        $passwoed = $_POST['password'];

        $result = $login->loggedin($usernameemail,$passwoed);
        ...
        <div class="container-fluid h-custom">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    <input type="email" name="usernameemail" id="form3Example3" class="form-control form-control-lg"
                    placeholder="Enter a valid email address" />
                    <label class="form-label" for="form3Example3">Usernaem Or Email address</label>
                </div>
