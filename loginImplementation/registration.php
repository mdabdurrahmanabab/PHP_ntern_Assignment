<?php
    ...
    $register = new DatabaseLogger();

    if (isset($_REQUEST['submit'])) {
        $name = $_POST['name'];
        $email = $_POST['email'];
        $passwoed = $_POST['password'];
        $confirmPasswoed = $_POST['confirmPassword'];

        $result = $register->registration($name,$email,$passwoed,$confirmPasswoed);
            ...
            <div class="col-lg-12 col-xl-11">
                ...
                <div class="card-body p-md-5">
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                        ...
                        <form action="" method="POST" class="mx-1 mx-md-4">
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class="small fw-bold mt-2 pt-1 mb-0">I've already account created..! <a href="loggedinterface.php"
                                    class="link-danger">logged in</a></p>
                            </div>
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                        ...
                        <img src="assets/image/draw1.webp" class="img-fluid" alt="Sample image">
